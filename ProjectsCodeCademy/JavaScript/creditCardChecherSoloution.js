...
// Add your functions below: Function to find a valid card number
...
// Test functions: Function to find a INVALID card number
console.log(validateCred(valid1)); // Should print true
console.log(validateCred(invalid1)); // Should print false

/// Function to find a INVALID card number
