//This code is for the computerized game of Paper Scissor and Rock


//    function name - function parameter; if ZERO or multiple, it must be inside parentheses. 
const getUserChoice = userInput => { // this function takes the USER's choice
  userInput=userInput.toLowerCase();
  if (userInput==='rock' || userInput==='paper' || userInput==='scissors') {
      return userInput;
  } else {
    console.log('Error, pls only type "rock", "paper" or "scissors"');
  }
};


const getComputerChoice = () => { // this function takes the COMPUTER's choice
...
const determineWinner= (userChoice, computerChoice) => {  //This function COMPARES both parties choices.
...
const playGame = () => {
  ...
  console.log('You threw: ' + userChoice);  //console.log(`You Threw ${userChoice}`);
