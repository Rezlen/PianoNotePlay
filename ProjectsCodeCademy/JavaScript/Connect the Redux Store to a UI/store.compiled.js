(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
  ...
  */
  ...
  var store = createStore(countReducer); //These below functions and elements will allow us to plug the Redux store into the UI. 
  ...
  var decrementer = document.getElementById('decrementer'); // 2-render: A state-change listener for responding to changes to the store‘s state. 
  ...
  render(); // In order for the UI to react to changes to the state of the store, you have to subscribe a change listener to the store using store.subscribe()
  
  store.subscribe(render); // 3-incrementerClicked and decrementerClicked: DOM event handlers for responding to the buttons being clicked by the user
  // DOM Event Handlers
